...
// View
import 'package:netconnectdemo/constants/color_block.dart';
import 'package:netconnectdemo/constants/config_app.dart';
import 'package:netconnectdemo/no_internet/no_internet_page.dart';
import 'package:netconnectdemo/no_internet/widgets/internet_connection_dialog.dart';

mixin NoInternetMixin {
  /// Banner
              ...
              if (!internetDialogShowing) {
                ...
                checkConnectionTimer = Timer(const Duration(seconds: 2), () {
                  ...
                  Connectivity().checkConnectivity().then(
                    (value) {
                      if (value != ConnectivityResult.bluetooth &&
